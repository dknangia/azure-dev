...
namespace FlyingDutchmanAirlines_Tests.ServiceLayer
{
    ...
    public class FlightServiceTests
    {
        ...
        public void Initialize()
        {
            ...
            _mockAirportRepository.Setup(repository => repository.GetAirportByID(31)).ReturnsAsync(new FlyingDutchmanAirlines.DatabaseLayer.Models.Airport
            {
                AirportId = 31,
                City = "Mexico City",
                Iata = "MEX"
            ...
            _mockAirportRepository.Setup(repository => repository.GetAirportByID(92)).ReturnsAsync(new FlyingDutchmanAirlines.DatabaseLayer.Models.Airport
            {
                AirportId = 92,
                City = "Ulaanbaatar",
                Iata = "UBN"
